        ...
        <div class="row">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Welcome to Yashinta Shop Catalog Website</h2>
                    </div>
                </div>
                <div class="pb-md-5">
...
<!-- <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/bg_3.jpg);"> -->
<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<?=base_url().'views/themes/'.theme_active().'/';?>images/bg_3.jpeg);">
    <div class="container">
    ...
    <div class="container">
        <div class="row block-9">
            ...
            <!-- <div class="col-md-12 d-flex" style="height:400px;">
                ...
                var latitude = -6.2550803;
                var longitude = 106.6995954;
